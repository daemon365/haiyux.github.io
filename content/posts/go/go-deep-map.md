---
title: "Go Map实现原理"
date: 2019-08-21T16:55:50+08:00
draft: false
toc: true
categories: [go]
tags: [golang]
...
![](/images/2344773-20210819141856894-1492869684-20211027165740537.png)
...
![](/images/2344773-20210819141923176-1324721640.png)
...
![](/images/2344773-20210819141946779-1042841437.png)
...
![](/images/2344773-20210819142013177-126486013.png)
...
![](/images/2344773-20210819142057108-415399910-20211027165945152.png)
...
![](/images/2344773-20210819142108776-44797569.png)
...
![](/images/2344773-20210819142126538-1685366358.png)

扩容完成后，overflow bucket 消失了，key 都集中到了一个 bucket，更为紧凑了，提高了查找的效率。

![](/images/2344773-20210819142136345-1006089973-20211027170027584.png)

假设触发了 2 倍的扩容，那么扩容完成后，老 buckets 中的 key 分裂到了 2 个 新的 bucket。一个在 x part，一个在 y 的 part。依据是 hash 的 lowbits。新 map 中 `0-3` 称为 x part，`4-7` 称为 y part。

![](/images/2344773-20210819142145045-718400942-20211027170044570.png)
...
![](/images/2344773-20210819142200674-1062452169.png)
...
![](/images/2344773-20210819142213736-74152524-20211027165819174.png)

这时，我们对此 map 进行遍历。假设经过初始化后，startBucket = 3，offset = 2。于是，遍历的起点将是 3 号 bucket 的 2 号 cell，下面这张图就是开始遍历时的状态：

![](/images/2344773-20210819142225745-1384453406-20211027165831244.png)
...
![](/images/2344773-20210819142236263-1977951984-20211027170004723.png)
...
![](/images/2344773-20210819142245303-1642830819-20211027170013620.png)
...
![](/images/2344773-20210819142256535-1317206573-20211027165927921.png)

和之前的流程一样，继续遍历新 1 号 bucket，发现老 1 号 bucket 已经搬迁，只用遍历新 1 号 bucket 中现有的元素就可以了。结果集变成：

![](/images/2344773-20210819142305536-1956315446-20211027165924319.png)

继续遍历新 2 号 bucket，它来自老 0 号 bucket，因此需要在老 0 号 bucket 中那些会裂变到新 2 号 bucket 中的 key，也就是 `lowbit == 10` 的那些 key。

这样，遍历结果集变成：

![](/images/2344773-20210819142318142-2106233495-20211027165919422.png)
